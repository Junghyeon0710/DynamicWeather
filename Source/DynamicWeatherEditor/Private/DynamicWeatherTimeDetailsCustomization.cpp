...
void FDynamicWeatherTimeDetailsCustomization::CustomizeChildren(TSharedRef<IPropertyHandle> PropertyHandle, IDetailChildrenBuilder& ChildBuilder, IPropertyTypeCustomizationUtils& CustomizationUtils)
{
	...
	ChildBuilder.AddProperty(PropertyHandle)
		...
		[
			...
			.Text(this, &FDynamicWeatherTimeDetailsCustomization::OnGetTimeText)
			.OnTextCommitted(this, &FDynamicWeatherTimeDetailsCustomization::OnTimeTextCommitted)
...
FText FDynamicWeatherTimeDetailsCustomization::OnGetTimeText() const
{
	TArray<void*> RawData;
...
void FDynamicWeatherTimeDetailsCustomization::OnTimeTextCommitted(const FText& InText, ETextCommit::Type CommitInfo)
{
	TArray<void*> RawData;
	TimeProperty->AccessRawData(RawData);
